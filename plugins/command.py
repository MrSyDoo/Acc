        ...
        try:
            for root, dirs, files in os.walk(extract_dir):
                ...
                if os.path.basename(root).startswith("D877F") and "maps" in files:
                    await message.reply(f"🔎 Found direct D877F folder: {root}")
